                  ...
                  Row(mainAxisAlignment: MainAxisAlignment.center, children: <
                    ...
                    GestureDetector(
                      onTap: () {
                        ...
                        TextEditingController amountValue =
                            TextEditingController();
                        TextEditingController msgValue =
                            TextEditingController();
                      ...
                      GestureDetector(
                        onTap: () async {
                          ...
                          TextEditingController apiValue =
                              TextEditingController(
                                  text: prefs.getString('api_key'));
                          TextEditingController secretValue =
                              TextEditingController(
                                  text: prefs.getString('secret'));
                          TextEditingController tickerValue =
                              TextEditingController(
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        DialogButton(
                            onPressed: () async {
                              globals.privKey =
                                  bip39.mnemonicToSeedHex(freshMnemonic);
